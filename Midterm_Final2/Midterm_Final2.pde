...
if (state=="Let's continue"){ 
text("which is the best?", 249, 201);
text("For Nescafe press 9", 400,350);
text ("For Abuelita press 0", 200,750);
Nescafe= loadImage("Nescafe.jpeg");
image(Nescafe, 580, 470);
Abuelita= loadImage("Abuelita.jpeg");
image(Abuelita, 210, 630);
}
if (state=="Is this the best") { 
  text("CocaCola or Pespi?", 249,201);
  text("CocaCola press m", 400, 350);
  text("Pespi press n", 200, 750);
  CocaCola=loadImage("CocaCola.png");
  image (CocaCola, 580, 470);
  Pepsi=loadImage("Pepsi.png");
  image(Pepsi, 210, 630); 
}
 if (state=="Continue"){
  text("What social media do you like?", 249,201);
  text("Instagram press l", 400, 350);
  text("Twitter press h", 200, 750);
  Instagram=loadImage("Instagram.jpeg");
  image (Instagram, 580, 470);
  Twitter=loadImage("Twitter.jpeg");
  image(Twitter, 210, 630);}
}
...
state ="Interesting";}
if(key=='5'){
  state="Is this the best";
}
if (key=='8'){
state= "What will you drink?";}
if (key=='j'){
state= "Let's continue";}
if (key=='k'){
state= "";}
if (key=='9'){
state="Next";}
